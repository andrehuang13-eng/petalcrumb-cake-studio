...
export default async function RequestACakePage({
  ...
  // Optional pre-fill when arriving from the "Request this cake" CTA on /cakes/[slug].
  // findFirst (not findUnique) because we also filter by status.
    ...
    <section className="mx-auto max-w-3xl px-6 md:px-12 py-16 md:py-24">
      ...
      <div className="max-w-2xl mb-12 md:mb-16">
        ...
        <h1 className="font-display text-5xl md:text-6xl lg:text-7xl leading-[0.95] tracking-[-0.02em] mb-6">
          Tell us about{" "}
          <em className="italic text-rose-deep">your celebration</em>.
        </h1>
